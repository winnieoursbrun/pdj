...
- `src/App.tsx` — shell : header (+ bouton installation PWA), 3 onglets, tab bar fixe en bas
- `src/tabs/` — `MapTab` (plan zoomable via react-zoom-pan-pinch + légende), `ProgramTab` (filtres jour/catégorie), `TimelineTab` (favoris chronologiques)
