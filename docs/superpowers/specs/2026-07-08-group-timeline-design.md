...
Itération V1.2 — présence « j'y suis » (2026-07-18) : pendant le festival, un membre peut signaler au groupe qu'il est **sur l'événement en cours** (un seul à la fois). Un bouton « J'y suis » apparaît sur les événements en cours (Programme et Ma timeline) quand on est en groupe ; la pastille de l'ami présent change d'aspect (jaune, ombre sticker, pin 📍, listée en premier) pour dire où il est. La présence expire d'elle-même à la fin de l'événement, côté émetteur comme côté lecteurs.
